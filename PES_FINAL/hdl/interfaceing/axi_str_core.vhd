...
entity axi_str_core is
    ...
    port (
        ...
        stream_data               : out std_logic_vector(C_S_AXIS_TDATA_WIDTH-1 downto 0);
        stream_enable             : out std_logic;

        pixel_buffer_busy         : in std_logic
        );
end axi_str_core;

architecture arch_imp of axi_str_core is
    ...
    begin
        ...
        S_AXIS_TREADY   <= axis_tready and not pixel_buffer_busy;
