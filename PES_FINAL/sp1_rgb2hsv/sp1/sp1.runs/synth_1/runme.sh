...
HD_PWD='C:/Users/ulyzk/Downloads/feature-calculation-template/sp1_rgb2hsv/sp1/sp1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb2hsv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rgb2hsv.tcl
